  ...
  return (
    <div className="shadow-input mx-auto w-[100%] text-black rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-white">
      <h2 className="text-2xl text-center font-bold text-black ">
        Welcome to Face<span className='text-[#03b303] ' >Pay</span> || LogIn
      </h2>
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <h3 className="text-2xl font-semibold text-center" >Don't have an account? <Link href="/auth/signup" className="text-[#03b303] font-semibold underline " >Sign Up</Link></h3>
        </div>
      </form>
    </div>
  );
